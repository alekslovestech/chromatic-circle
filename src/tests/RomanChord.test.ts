...
describe("RomanNumeral chord tests", () => {
  ...
  //pure accidentals
  test("♯I", () => {
    verifyRomanChord("♯I", new RomanChord(1, ChordType.Major, AccidentalType.Sharp));
  });

  test("♭I", () => {
    verifyRomanChord("♭I", new RomanChord(1, ChordType.Major, AccidentalType.Flat));
  });
  ...
  //chord suffixes
  test("I7", () => {
    verifyRomanChord("I7", new RomanChord(1, ChordType.Dominant7));
  });
  ...
  test("Imaj7", () => {
    verifyRomanChord("Imaj7", new RomanChord(1, ChordType.Major7));
  });
  ...
  test("♯Imaj7", () => {
    verifyRomanChord("♯Imaj7", new RomanChord(1, ChordType.Major7, AccidentalType.Sharp));
  });

  //slash chords
  test("I/V (slash chord)", () => {
    verifyRomanChord("I/V", new RomanChord(1, ChordType.Major, undefined, 5));
  });
  ...
  test("i/V (Minor/major)", () => {
    verifyRomanChord("i/V", new RomanChord(1, ChordType.Minor, undefined, 5));
  });
});
